...
export class AddDetalleToCategoria1718132968979 implements MigrationInterface {
    name = 'AddDetalleToCategoria1718132968979'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categoria" ("id" SERIAL NOT NULL, "nombreCategoria" character varying NOT NULL, "detalle" character varying, CONSTRAINT "PK_f027836b77b84fb4c3a374dc70d" PRIMARY KEY ("id"))`);
